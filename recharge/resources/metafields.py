...
class RechargeMetafield(RechargeResource):
    ...
    def create(self, data):
        ...
        """
        return self.__base_post(self.url, None, data)
    ...
    def retrieve(self, metafield_id):
        ...
        """
        return self.__base_get(f'{self.url}/{metafield_id}', None)
    ...
    def update(self, metafield_id, data):
        ...
        """
        return self.__base_put(f'{self.url}/{metafield_id}', None, data)
    ...
    def delete(self, metafield_id):
        ...
        """
        return self.__base_delete(f'{self.url}/{metafield_id}', None)
    ...
    def list(self, data=None):
        ...
        """
        return self.__base_get(self.url, None, data)
    ...
    def count(self, data=None):
        ...
        """
        return self.__base_get(f'{self.url}/count', None, data)
